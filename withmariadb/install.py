...
rPackages = ["libcurl3", "libxslt1-dev", "libgeoip-dev", "e2fsprogs", "wget", "mcrypt", "nscd", "htop", "zip", "unzip", "mc", "python-paramiko", "mariadb-server"]
...
def prepare(rType="MAIN"):
    ...
    if rVersion == "11":
        ...
        os.system("wget --user-agent=\"Mozilla/5.0\" -q -O /tmp/libssl1.deb https://snapshot.debian.org/archive/debian-security/20190925T211341Z/pool/updates/main/o/openssl/libssl1.0.0_1.0.1t-1%2Bdeb8u12_amd64.deb")
        os.system("wget --user-agent=\"Mozilla/5.0\" -q -O /tmp/multiarch-support.deb http://snapshot.debian.org/archive/debian/20190501T215844Z/pool/main/g/glibc/multiarch-support_2.28-10_amd64.deb")
        os.system("dpkg -i /tmp/multiarch-support.deb > /dev/null")
